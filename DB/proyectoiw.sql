...
--
-- Host: localhost    Database: proyectoiw
-- ------------------------------------------------------
...
DROP DATABASE IF EXISTS proyectoiw;
CREATE DATABASE proyectoiw;
USE proyectoiw;
...
INSERT INTO `Citas` VALUES (1,'2019-11-27','12:00:00','Se requiere la colocación de ortodoncia',1,1),(2,'2019-11-28','14:00:00','Cita de rutina para revisión',2,2);
...
CREATE TABLE `Reseñas` (
  ...
  KEY `fk_Dentista_Reseñas_idx` (`idDentista`),
  CONSTRAINT `fk_Dentista_Reseñas` FOREIGN KEY (`idDentista`) REFERENCES `dentista` (`iddentista`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Reseñas` VALUES (1,'El trato por parte del doctor fue excelente',5,1),(2,'El tratamiento fue más caro de lo que esperaba',3,2);
...
INSERT INTO `Solicitudes` VALUES (1,'Rodrigo','Martinez López',123456,221123456,'Avenida norte 1032 ','Especialista en Ortodoncia graduado de la BUAP','example@gmail.com','toor','Dentista'),(2,'Ricardo','Hernández García',654321,222865440,'Calle C 1014 Jardines de San Manuel','Especialidad en Endodoncia graduado de la BUAP','example@hotmail.com','123456','Dentista');
...
-- Dump completed on 2019-11-26 14:32:30
