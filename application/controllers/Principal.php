...
class Principal extends CI_Controller {
	...
	public function perfil(){
		...
		if ($this->session->userdata('tipo')=='Dentista') {
			...
			$data["reseñas"]=$this->modelo->obtenerReseñas();
	...
	public function crearR(){
		...
		//--Se obtienen los valores del formulario con POST--//
		$reseña=$this->input->post('reseña',TRUE);
		$calificacion=$this->input->post('calificacion',TRUE);
		$idDentista=$this->uri->segment(3);
