		...
		<?php if ($dentistas != FALSE) {$i=0;
			...
			foreach ($dentistas->result() as $dentista) {$i++;?>
				...
				<div class="container-fluid" style="margin-top:1em">
		            ...
		            <?php if ($reseñas != FALSE) {$i=0;
		            	foreach ($reseñas->result() as $reseña) {$i++;?>

		            		<?php if($reseña->idDentista == $this->session->userdata('id')){?>
		            		...
		            		<div class="row">
		            			...
		            			<div class="col-sm-8">
		            				<h2>Reseña</h2>
		            				<br>
		            				<label class="text-center"><?php echo $reseña->contenido; ?></label>
		            			</div>

		            			<div class="col-sm-4">
		            				<h2>Calificaci&oacute;n</h2>
		            				<br>
		            				<?php 
		            				switch ($reseña->calificacion) {
		            					case 1:
		            				 		?><div class="row d-inline">
		            				 			<div class="col-sm-12">
		            				 				<img src="<?php echo base_url(); ?>img/estrella.png" class="img-responsive img-fluid mx-auto d-inline-block" style="width:5%">
		            				 			</div>
		            				 		</div>
		            				 		<?php
		            				 		break;
		            				 ...
		            				 ?>
		            				<!--<label class="text-center"><?php echo $reseña->calificacion; ?></label>-->
		            			</div>
