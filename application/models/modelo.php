...
class modelo extends CI_Model{
	...
	public function obtenerReseñas(){
		$cadena="select * from Reseñas order by idReseña";
	...
	public function añadirCita($data){
		$cadena="insert into Citas(fecha, hora, notas, idUsuario, idDentista) values('".$data["fecha"]."', '".$data["hora"]."', '".$data["notas"]."', ".$data["idUsuario"].",".$data["dentista"].")";
	...
	public function añadirReseña($data){
		$cadena="insert into Reseñas(contenido, calificacion, idDentista) values('".$data["reseña"]."', ".$data["calificacion"].",".$data["idDentista"].")";
